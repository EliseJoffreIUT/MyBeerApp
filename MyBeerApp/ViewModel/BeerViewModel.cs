...
namespace MyBeerApp.ViewModel
{
    public class BeerViewModel : INotifyPropertyChanged
    {
        ...
        private void InitializeListOfbeers()
        {
            ...
            beers.Add(new Beer("Paix Dieu", "paixdieu.jpg", "Une bière blonde artisanale de type Triple. Elle n'est brassée qu'une seule fois par mois lors de la pleine lune. "));
